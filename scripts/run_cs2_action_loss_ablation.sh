#!/usr/bin/env bash
# Paired action-conditioning diagnostic on the full Dust2 test split.
#
# Validation diffusion loss is recomputed with true, cross-POV-shifted, temporally shifted, and
# zero actions. Each mode gets identical videos, midpoint windows, checkpoints, and diffusion RNG.
set -euo pipefail
...
eval_root=${CS1K_ACTION_EVAL_ROOT:-$run_root/evaluation/action_loss_seed_sweep}
